...
START_TEST(tree_test) {
    ...
    ck_assert_int_eq(tree_depth_first_insert(&t, &a0, NULL, cmp), 0);
    ck_assert_int_eq(tree_depth_first_insert(&t, &a1, &a0, cmp), 0);
    ck_assert_int_eq(tree_depth_first_insert(&t, &a2, &a1, cmp), 0);
    ck_assert_int_eq(tree_breadth_first_insert(&t, &a3, &a1, cmp), 0);
    ck_assert_int_eq(tree_breadth_first_insert(&t, &a4, &a3, cmp), 0);
    ck_assert_int_eq(tree_breadth_first_insert(&t, &a5, &a2, cmp), 0);
    ...
    ck_assert_int_eq(tree_depth_first_delete(&t, &a5, cmp, NULL), 0);
    ck_assert_int_eq(tree_breadth_first_delete(&t, &a3, cmp, NULL), 0);
    ck_assert_int_eq(tree_depth_first_delete(&t, &not_in, cmp, NULL), -1);
