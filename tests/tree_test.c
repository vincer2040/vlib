...
START_TEST(tree_test) {
    ...
    ck_assert_int_eq(tree_depth_first_insert(&t, &a3, &a1, cmp), 0);
    ck_assert_int_eq(tree_depth_first_insert(&t, &a4, &a3, cmp), 0);
    ck_assert_int_eq(tree_depth_first_insert(&t, &a5, &a2, cmp), 0);
    ...
    ck_assert_int_eq(tree_depth_first_delete(&t, &a3, cmp, NULL), 0);
