...
/*********************************************************************
 * This file was modified by Vince Ronnebaum <ronnebaumvince AT gmail.com>
 * in the following ways:
 *
 * 1.           When ctx->bitlens is assigned to ctx->data, ctx->bitlens is
 *              cast to a BYTE (unsigned char)
 *
 * 2.           Some formatting preferences
 *********************************************************************/
...
void sha256_final(SHA256_CTX* ctx, BYTE hash[]) {
    ...
    big endian, reverse all the bytes when copying the final state to the output
    hash. */
    for (i = 0; i < 4; ++i) {
